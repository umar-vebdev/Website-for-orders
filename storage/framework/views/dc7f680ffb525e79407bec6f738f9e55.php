...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> – Control Panel</title>
...
<body class="min-h-screen bg-night text-gray-100 font-sans">
    ...
    <button id="burgerBtn" aria-label="������� ����" class="fixed top-4 right-4 z-[60] w-12 h-12 flex items-center justify-center bg-accent text-white rounded-2xl md:hidden shadow-lg shadow-accent/20">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-nav-link','data' => ['href' => ''.e(route('admin.dashboard')).'','icon' => 'fa-chart-pie','label' => 'Панель']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('admin.dashboard')).'','icon' => 'fa-chart-pie','label' => 'Панель']); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal587edaf313e0ec074acea90d82299dd9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal587edaf313e0ec074acea90d82299dd9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-nav-link','data' => ['href' => ''.e(route('admin.dishes')).'','icon' => 'fa-utensils','label' => 'Блюда']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('admin.dishes')).'','icon' => 'fa-utensils','label' => 'Блюда']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal587edaf313e0ec074acea90d82299dd9)): ?>
<?php $attributes = $__attributesOriginal587edaf313e0ec074acea90d82299dd9; ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal587edaf313e0ec074acea90d82299dd9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal587edaf313e0ec074acea90d82299dd9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-nav-link','data' => ['href' => ''.e(route('admin.orders.index')).'','icon' => 'fa-receipt','label' => 'Заказы']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('admin.orders.index')).'','icon' => 'fa-receipt','label' => 'Заказы']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal587edaf313e0ec074acea90d82299dd9)): ?>
<?php $attributes = $__attributesOriginal587edaf313e0ec074acea90d82299dd9; ?>
...
<?php endif; ?>
            ...
            <div class="pt-6 border-t border-white/5 mt-6">
                ...
                <?php if (isset($component)) { $__componentOriginal587edaf313e0ec074acea90d82299dd9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal587edaf313e0ec074acea90d82299dd9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-nav-link','data' => ['href' => ''.e(route('admin.register')).'','icon' => 'fa-user-shield','label' => 'Регистрация']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('admin.register')).'','icon' => 'fa-user-shield','label' => 'Регистрация']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal587edaf313e0ec074acea90d82299dd9)): ?>
<?php $attributes = $__attributesOriginal587edaf313e0ec074acea90d82299dd9; ?>
    ...
    <main id="mainContent" class="flex-1 transition-all duration-300 md:ml-72 min-h-screen">
        ...
        <header class="h-20 border-b border-white/5 flex items-center justify-between px-8 sticky top-0 bg-night/80 backdrop-blur-md z-40">
            ...
            <div class="flex items-center gap-4">
                <a href="<?php echo e(route('menu')); ?>" target="_blank" aria-label="������� ���� � ����� �������" class="text-xs font-bold text-slate-500 hover:text-accent transition flex items-center gap-2 uppercase tracking-tighter">
...
<?php /**PATH C:\Users\user\food-project\resources\views/layouts/admin.blade.php ENDPATH**/ ?>