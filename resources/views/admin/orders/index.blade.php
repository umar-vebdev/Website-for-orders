                ...
                <div class="flex flex-wrap items-center gap-2 p-3 bg-[#020617]/80 border border-slate-800 rounded-2xl hover:bg-[#020617] transition w-full overflow-hidden">
                    ...
                    <div class="flex items-center gap-2 mt-2 sm:mt-0 flex-shrink-0">
                        <form method="POST" action="{{ route('admin.orders.updateStatus', $order->id) }}" class="flex items-center gap-1">
                            @csrf
                            <select name="status" class="bg-gray-800 text-white text-xs rounded px-2 py-1 border border-slate-700 flex-shrink-0">
                            ...
                            <button type="submit" class="bg-blue-600 hover:bg-blue-500 text-white text-xs rounded px-2 py-1 transition flex-shrink-0">
                                Сохранить
                            </button>
                        </form>
                    
                        <a href="{{ route('admin.orders.show', $order->id) }}" class="bg-gray-700/50 hover:bg-gray-700 text-blue-400 hover:text-blue-300 text-xs rounded px-2 py-1 transition flex-shrink-0">
                            Просмотр
                        </a>
                    </div>
